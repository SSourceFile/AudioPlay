//
// Created by hmh on 2022/3/15.
//

#ifndef AUDIOTRACKPLAY_SLAUDIORECORD_H
#define AUDIOTRACKPLAY_SLAUDIORECORD_H
...
public:
    void startRecord(const char *savePath);
...
#endif //AUDIOTRACKPLAY_SLAUDIORECORD_H
